...
I eventually found two solutions, one being the same as the solution of [Shadows Appearing in Distance](Shadows-Appearing-in-Distance.md), though it consists of disabling Ray Traced Shadows for landscape.

If you don't wish to give up Ray Traced Shadows, the other solution is to increase r.RayTracing.NormalBias to a value about 5 in Console Command, the default being 0.1.
